        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-slate-500 dark:text-slate-400">Gestiona las citas de tus pacientes</p>
                </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-12 text-center border border-slate-100 dark:border-slate-700 shadow-sm">
                ...
                <p className="text-slate-500 dark:text-slate-400 max-w-md mx-auto">
                    El módulo completo de gestión de citas estará disponible en la próxima actualización.
                    Por ahora, puedes agendar citas desde el Dashboard.
                </p>
            </div>
        </div>
    );
